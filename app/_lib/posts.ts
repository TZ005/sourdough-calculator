...
const POSTS: Post[] = [
  ...
  { slug: "best-sourdough-starter-kit", title: "Best Sourdough Starter Kit for Beginners (2026): What You Actually Need", excerpt: "You do not need a $60 kit. Here are the 4 things worth buying, the 3 things to skip, and exact Amazon picks for 2026.", readTime: "7 min" },
  ...
  { slug: "store-sourdough-bread", title: "How to Store Sourdough Bread (5 Methods That Actually Work) [2026]", excerpt: "Stop sourdough going stale in 24 hours. Tested 5 storage methods — room temp, paper bag, freezer, and more. Plus a printable cheat sheet.", readTime: "8 min" },
