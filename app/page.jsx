    ...
    <>
      <section className="py-16 md:py-20 text-center bg-gradient-to-b from-brand-cream to-brand-tan">
        <div className="max-w-6xl mx-auto px-6">
          <picture><source srcSet="/og-image.webp" type="image/webp" /><img src="/og-image.png" alt="Hand-drawn watercolor illustration of sourdough baking tools and a fresh loaf" width="1200" height="630" className="w-full max-w-4xl mx-auto rounded-2xl shadow-lg mb-10" loading="eager" /></picture>
