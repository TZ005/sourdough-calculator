      ...
      <section className="py-12 bg-brand-tan">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-5xl mx-auto">
            <a href="https://www.amazon.com/dp/B0FBZ64DVL?tag=sourdoughca0a-20" target="_blank" rel="sponsored nofollow noopener noreferrer" aria-label="Buy King Arthur Bread Flour on Amazon - 100% Organic, Unbleached, 5 lb" title="King Arthur Bread Flour on Amazon" className="bg-white p-5 rounded-lg shadow hover:shadow-lg transition-shadow">
            ...
            <a href="https://www.amazon.com/dp/B00U1OCPWQ?tag=sourdoughca0a-20" target="_blank" rel="sponsored nofollow noopener noreferrer" aria-label="Buy Lodge Dutch Oven on Amazon - 6 Quart Enameled Cast Iron" title="Lodge Dutch Oven on Amazon" className="bg-white p-5 rounded-lg shadow hover:shadow-lg transition-shadow">
            ...
            <a href="https://www.amazon.com/dp/B07XXSYLL8?tag=sourdoughca0a-20" target="_blank" rel="sponsored nofollow noopener noreferrer" aria-label="Buy ThermoPro TP19 Thermometer on Amazon - Instant read, waterproof" title="ThermoPro TP19 Thermometer on Amazon" className="bg-white p-5 rounded-lg shadow hover:shadow-lg transition-shadow">
            ...
            <a href="https://www.amazon.com/dp/B01LY7NDQ9?tag=sourdoughca0a-20" target="_blank" rel="sponsored nofollow noopener noreferrer" aria-label="Buy Sourdough Bread Lame on Amazon - Scoring tool with replacement blades" title="Sourdough Bread Lame on Amazon" className="bg-white p-5 rounded-lg shadow hover:shadow-lg transition-shadow">
            ...
            <a href="https://www.amazon.com/dp/B0113UZJE2?tag=sourdoughca0a-20" target="_blank" rel="sponsored nofollow noopener noreferrer" aria-label="Buy Etekcity Kitchen Scale on Amazon - Multifunction, stainless steel" title="Etekcity Kitchen Scale on Amazon" className="bg-white p-5 rounded-lg shadow hover:shadow-lg transition-shadow">
