...
const POSTS = [
  ...
  { slug: "store-sourdough-bread",
    ...
    excerpt: "Room temperature, frozen, or as dough. The right way to store sourdough at every stage so it stays fresh and crusty for days, not hours.",
    readTime: "8 min",
  },
  { slug: "whole-wheat-sourdough",
    title: "Whole Wheat Sourdough: A Complete Guide to 100% Whole Grain Bread",
    excerpt: "100% whole wheat sourdough is doable. Higher hydration, shorter ferment, and a few simple adjustments for an open, chewy, flavor-packed loaf.",
    readTime: "10 min",
  },
  { slug: "levain-vs-starter",
    title: "Sourdough Levain vs Starter: What Is the Difference?",
    excerpt: "Starter is what you keep. Levain is what you build. Learn the difference, when to use each, and how to build a levain that peaks exactly when you need it.",
    readTime: "6 min",
  },
  { slug: "sourdough-for-beginners",
    title: "Sourdough for Beginners: The Complete First-Time Guide",
    excerpt: "Want to make your first sourdough loaf? Step-by-step from building a starter to baking your first crusty boule. No experience needed.",
    readTime: "12 min",
  },
  { slug: "sourdough-focaccia",
    title: "Sourdough Focaccia: The Easiest Sourdough Bread You Will Ever Bake",
    excerpt: "Sourdough focaccia is the easiest sourdough bread to make. No shaping, no scoring, no Dutch oven. Mix, rise, dimple, bake. Restaurant-quality at home.",
    readTime: "7 min",
  },
  { slug: "sourdough-bagels",
    title: "Sourdough Bagels: Chewy, Shiny, and Easier Than You Think",
