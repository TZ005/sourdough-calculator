    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: {"@context":"https://schema.org","@type":"Article","headline":"Whole Wheat Sourdough: A Complete Guide to 100% Whole Grain Bread (2026)","description":"100% whole wheat sourdough is doable at home. Higher hydration, shorter ferment, and a few simple adjustments give you a loaf that is open, chewy, and packed with flavor.","image":"https://sourdough-hydrationcalculator.com/images/blog/whole-wheat-sourdough.png","author":{"@type":"Organization","name":"SourdoughCalc","url":"https://sourdough-hydrationcalculator.com/"},"publisher":{"@type":"Organization","name":"SourdoughCalc","logo":{"@type":"ImageObject","url":"https://sourdough-hydrationcalculator.com/og-image.png","width":1200,"height":630}},"url":"https://sourdough-hydrationcalculator.com/blog/whole-wheat-sourdough/","mainEntityOfPage":{"@type":"WebPage","@id":"https://sourdough-hydrationcalculator.com/blog/whole-wheat-sourdough/"},"datePublished":"2026-07-25","dateModified":"2026-07-25"}
        }}
      />
      ...
      <ul className="list-disc pl-6 space-y-2 my-4">
        ...
        <li><strong>Germ adds enzymes.</strong> Wheat germ contains enzymes that break down gluten and starch. Ferments faster.</li>
      </ul>
      ...
      <p className="mb-4"><strong>For 500g flour (1 loaf):</strong></p>
      <ul className="list-disc pl-6 space-y-2 my-4">
        <li>Whole wheat flour: 500g</li>
        <li>Water (warm, 85F): 425g</li>
      ...
      <h3 className="mt-6 mb-3 text-xl font-semibold">Step 2: Add Starter and Salt</h3>
      <p className="mb-4">Add the starter and salt. Mix with wet hands until fully incorporated. Dough will be sticky and shaggy. That is normal.</p>

      <h3 className="mt-6 mb-3 text-xl font-semibold">Step 3: Short Bulk Ferment (3-4 hours at 78F)</h3>
      <p className="mb-4">Whole wheat ferments faster than white. Aim for 3-4 hours at 78F, shorter than 4-6 hours for white dough. Do 3 sets of stretch and folds in the first 90 minutes.</p>

      <h3 className="mt-6 mb-3 text-xl font-semibold">Step 4: Pre-Shape and Shape</h3>
      <p className="mb-4">Pre-shape into a round, rest 15 minutes, then shape into a boule or batard. Do not over-shape.</p>

      <h3 className="mt-6 mb-3 text-xl font-semibold">Step 5: Cold Proof (12-16 hours)</h3>
      <p className="mb-4">Place shaped loaf in a banneton or bowl lined with a floured tea towel. Refrigerate 12-16 hours.</p>
