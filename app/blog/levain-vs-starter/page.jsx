    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: {"@context":"https://schema.org","@type":"Article","headline":"Sourdough Levain vs Starter: What Is the Difference? (2026)","description":"Starter is what you keep. Levain is what you build. Learn the difference, when to use each, and how to build a levain that peaks exactly when you need it.","image":"https://sourdough-hydrationcalculator.com/images/blog/levain-vs-starter.png","author":{"@type":"Organization","name":"SourdoughCalc","url":"https://sourdough-hydrationcalculator.com/"},"publisher":{"@type":"Organization","name":"SourdoughCalc","logo":{"@type":"ImageObject","url":"https://sourdough-hydrationcalculator.com/og-image.png","width":1200,"height":630}},"url":"https://sourdough-hydrationcalculator.com/blog/levain-vs-starter/","mainEntityOfPage":{"@type":"WebPage","@id":"https://sourdough-hydrationcalculator.com/blog/levain-vs-starter/"},"datePublished":"2026-07-25","dateModified":"2026-07-25"}
        }}
      />
      ...
      <h1 className="mt-4 mb-3">Sourdough Levain vs Starter: What Is the Difference?</h1>
      ...
      <ul className="list-disc pl-6 space-y-2 my-4">
        ...
        <li><strong>Bad timing.</strong> The starter lives in the fridge and is mildly active. The levain is built to peak activity in 4-8 hours. If you use the starter straight, your dough will ferment unpredictably.</li>
      ...
      <ul className="list-disc pl-6 space-y-2 my-4">
        ...
        <li><strong>1:2:2</strong> peaks in 6-8 hours. Use when you want to bake in the evening after a morning build.</li>
        <li><strong>1:3:3</strong> peaks in 8-12 hours. Best for overnight levain at room temperature.</li>
        <li><strong>1:5:5 or 1:10:10</strong> peaks in 12-24 hours. Use for a cold levain in the fridge.</li>
      </ul>
      ...
      <p className="mb-4">Mix in a clean jar, cover loosely, and leave at room temperature (75-78F). Wait 4-6 hours. The levain is ready when it has at least doubled in volume, has lots of bubbles on top and sides, and smells pleasantly tangy (not harsh or vinegary). It should be at its peak rise, just starting to dome and slowly fall back at the edges.</p>
      <p className="mb-4">If you use the levain before it peaks, your dough will be under-leavened. If you wait too long after peak, the yeast has exhausted its food and your dough will be sluggish. Aim for peak to peak-minus-30-minutes.</p>

      <h2 className="mt-10 mb-3">FAQ</h2>
      <h3 className="mt-6 mb-3 text-xl font-semibold">Can I use my starter straight from the fridge without building a levain?</h3>
      <p className="mb-4">Technically yes, but it is unpredictable. A cold starter is sluggish. A recently fed levain is at peak activity and will leaven your dough faster and more reliably.</p>
      <h3 className="mt-6 mb-3 text-xl font-semibold">How much starter do I need to keep to build a levain?</h3>
      <p className="mb-4">About 30-50g is enough. Keep a small amount (a few tablespoons) in a jar, feed it weekly, and use a bit of it to build your levain when you want to bake.</p>
      <h3 className="mt-6 mb-3 text-xl font-semibold">Can I use the same jar for starter and levain?</h3>
      <p className="mb-4">No. Keep them separate. The starter should be the stable culture you always come back to. The levain is a one-time build. Mixing containers can lead to confused ferments and inconsistent results.</p>
